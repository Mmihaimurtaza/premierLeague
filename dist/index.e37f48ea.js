...
var _teamsViewJs = require("../views/teamsView.js");
var _teamsViewJsDefault = parcelHelpers.interopDefault(_teamsViewJs);
var _matchesViewJs = require("../views/matchesView.js");
var _matchesViewJsDefault = parcelHelpers.interopDefault(_matchesViewJs);
var _standingsViewJs = require("../views/standingsView.js");
var _standingsViewJsDefault = parcelHelpers.interopDefault(_standingsViewJs);
var _tableWeeksViewJs = require("../views/tableWeeksView.js");
var _tableWeeksViewJsDefault = parcelHelpers.interopDefault(_tableWeeksViewJs);
var _runtime = require("regenerator-runtime/runtime");
if (module.hot) module.hot.accept;
const controlTeamsResults = async function() {
    try {
        await _modelJs.loadTeams("teams");
        (0, _teamsViewJsDefault.default).render(_modelJs.state.teams);
    } catch (err) {
        console.log(err);
    }
};
const controlMatchesResults = async function() {
    try {
        await _modelJs.loadMatches("matches");
        (0, _matchesViewJsDefault.default).render([
            _modelJs.state.matches,
            _modelJs.state.matchweek
        ]);
    } catch (err) {
        console.log(err);
    }
...
const controlStandingsResults = async function() {
    try {
        await _modelJs.loadStandings("standings");
        (0, _standingsViewJsDefault.default).render(_modelJs.state.standings);
    } catch (err) {
        console.log(err);
    }
};
const controlTableWeeks = async function() {
    try {
        ...
        (0, _tableWeeksViewJsDefault.default).render([
            _modelJs.state.matchweeks,
            _modelJs.state.matchweek
        ]);
    } catch (err) {
        console.log(err);
...
(0, _teamsViewJsDefault.default).addHandlerRender(controlTeamsResults);
(0, _matchesViewJsDefault.default).addHandlerRender(controlMatchesResults);
(0, _standingsViewJsDefault.default).addHandlerRender(controlStandingsResults);
(0, _tableWeeksViewJsDefault.default).addHandlerRender(controlTableWeeks);
(0, _tableWeeksViewJsDefault.default).toggleTableWeeks();
(0, _tableWeeksViewJsDefault.default).changeActiveWeek(controlChangeActiveWeeks);

},{"./model.js":"Y4A21","./config":"k5Hzs","../views/teamsView.js":"85VrY","../views/matchesView.js":"4aU17","../views/standingsView.js":"a4QVi","../views/tableWeeksView.js":"1Gbyq","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "loadTeams", ()=>loadTeams);
parcelHelpers.export(exports, "loadMatches", ()=>loadMatches);
parcelHelpers.export(exports, "loadStandings", ()=>loadStandings);
parcelHelpers.export(exports, "updateMatchweek", ()=>updateMatchweek);
...
const loadTeams = async function(query) {
    try {
        const data = await (0, _helpers.getJSON)(`${(0, _config.API_URL)}${query}`, (0, _config.OPTIONS));
...
const loadMatches = async function(query) {
    try {
        const data = await (0, _helpers.getJSON)(`${(0, _config.API_URL)}${query}`, (0, _config.OPTIONS));
...
const loadStandings = async function(query) {
    try {
        const data = await (0, _helpers.getJSON)(`${(0, _config.API_URL)}${query}`, (0, _config.OPTIONS));
...
const updateMatchweek = function(week) {
...
parcelHelpers.export(exports, "TEAMS_LINKS", ()=>TEAMS_LINKS);
parcelHelpers.export(exports, "OPTIONS", ()=>OPTIONS);
parcelHelpers.export(exports, "TIMEOUT_SEC", ()=>TIMEOUT_SEC);
const API_URL = "https://api.football-data.org/v4/competitions/PL/";
const TEAMS_LINKS = {
...
const getJSON = async function(url) {
    try {
        const fetchPro = fetch(url, (0, _config.OPTIONS));
...
},{"regenerator-runtime":"dXNgZ","./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"85VrY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class TeamsView extends (0, _viewJsDefault.default) {
...
exports.default = new TeamsView();

},{"./view.js":"ibqJr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ibqJr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    _data;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4aU17":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
class MatchesView extends (0, _viewDefault.default) {
...
exports.default = new MatchesView();

},{"./view":"ibqJr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a4QVi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class StandingsView extends (0, _viewJsDefault.default) {
...
exports.default = new StandingsView();

},{"./view.js":"ibqJr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Gbyq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class TableWeeksView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkupWeeksTable(matchweeks, matchweek) {
        ...
        let html = "";
        for(let i = 1; i <= matchweeks; i++)html += ` <p  class = "c${i} ${matchweek === i ? "active" : ""} " data-id="${i}"> week ${i}</p>`;
        return html;
    }
    ...
    changeActiveWeek(handler) {
        ...
        dropDown.addEventListener("click", function(e) {
            ...
            for (const week of dropDown.children)if (clickedMatchWeek === week.dataset.id) week.classList.add("active");
...
exports.default = new TableWeeksView();

},{"./view.js":"ibqJr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequireea6d")
